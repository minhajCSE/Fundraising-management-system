                ...
                <div class="container-fluid">
                    ...
                    <div class="btn-group pull-right" >
                        <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="icon-user"></i><span class="hidden-phone"><?php echo $this->session->userdata('donor_username'); ?></span>
                            <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu">
                            <li><a href="">Profile</a></li>
                            <li class="divider"></li>
                            <li><a href="<?php echo base_url(); ?>donor_login/donor_logout">Logout</a></li>
                        </ul>
                    </div>
                    <!-- user dropdown ends -->
                ...
                <div class="span2 main-menu-span">
                    <div class="well nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a class="ajax-link" href="<?php echo base_url() ;?>donor_login/donor_profile/<?php echo $this->session->userdata('donor_id'); ?>"><i class="icon-user"></i><span class="hidden-tablet">Profile</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url() ;?>donor_login/add_fund_story.html"><i class="icon-edit"></i><span class="hidden-tablet">Add Fund Story</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url() ;?>donor_login/manage_fund_story/<?php echo $this->session->userdata('donor_id'); ?>"><i class="icon-edit"></i><span class="hidden-tablet">Manage Fund</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url() ;?>donor_login/fund_request/<?php echo $this->session->userdata('donor_id'); ?>"><i class="icon-edit"></i><span class="hidden-tablet">Fund Request</span></a></li>
                        </ul>
