...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Funraising Admin Panel</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="Charisma, a fully featured, responsive, HTML5, Bootstrap admin template.">
        <meta name="author" content="Minhajul Islam">
                ...
                <div class="row-fluid">
                    <div class="well span5 center login-box">
                        ...
                        <div class="">
                            <h2 style="color: red">
                                <?php
                                $exe = $this->session->userdata('execption');
                                if (isset($exc)) {
                                    echo $exc;
                        ...
                        <form class="form-horizontal" action="<?php echo base_url(); ?>administrator/check_admin_login.html" method="post">
                            <fieldset>
                                <div class="input-prepend" title="Username" data-rel="tooltip">
                                    <span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" name="admin_username" id="username" type="text" value="" />
                                </div>
