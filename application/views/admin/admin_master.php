        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="index.html"><span>Fundraising</span></a>
                    ...
                    <div class="btn-group pull-right" >
                        <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="icon-user"></i><span class="hidden-phone"><?php echo $this->session->userdata('admin_username'); ?></span>
                ...
                <div class="span2 main-menu-span">
                    <div class="well nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a class="ajax-link" href="<?php echo base_url(); ?>super_admin/index.html"><i class="icon-home"></i><span class="hidden-tablet"> Dashboard</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url() ?>super_admin/add_navigation.html"><i class="icon-eye-open"></i><span class="hidden-tablet">Add Navigation</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url() ;?>super_admin/add_category.html"><i class="icon-edit"></i><span class="hidden-tablet">Add Category</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url() ;?>super_admin/manage_category.html"><i class="icon-edit"></i><span class="hidden-tablet">Manage Category</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url() ;?>super_admin/add_news.html"><i class="icon-edit"></i><span class="hidden-tablet">Add News</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url() ;?>super_admin/manage_news.html"><i class="icon-edit"></i><span class="hidden-tablet">Manage News</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url() ;?>super_admin/add_success_story.html"><i class="icon-edit"></i><span class="hidden-tablet">Add Success Story</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url() ; ?>super_admin/manage_contact_message.html"><i class="icon-list-alt"></i><span class="hidden-tablet">Manage Contact</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url() ; ?>super_admin/add_company_info.html"><i class="icon-list-alt"></i><span class="hidden-tablet">Add Organization</span></a></li>
                            <li><a class="ajax-link" href="<?php echo base_url() ; ?>super_admin/manage_organization.html"><i class="icon-list-alt"></i><span class="hidden-tablet">Manage Organization</span></a></li>
